...
ATOM                RegisterViewerClass(HINSTANCE hInstance);
    ...
    case WM_PAINT:
        {
            ...
            Media::MGSize windowSize(windowRect.right - windowRect.left, windowRect.bottom - windowRect.top);

            Media::MGBox box = Media::letterBox(windowSize, imageSize);

            graphics.DrawImage(&image, 
                static_cast<int>(box.min_corner().get<0>()), 
                static_cast<int>(box.min_corner().get<1>()),
                static_cast<int>(box.max_corner().get<0>() - box.min_corner().get<0>()),
                static_cast<int>(box.max_corner().get<1>() - box.min_corner().get<1>()));
